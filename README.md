...
[![build-ublue](https://github.com/Gaming4LifeDE/cosmos-os/actions/workflows/build.yml/badge.svg)](https://github.com/Gaming4LifeDE/cosmos-os/actions/workflows/build.yml)
...
> **Note**
> Everywhere in this repository, make sure to replace `Gaming4LifeDE/cosmos-os` with the details of your own repository. Unless you used one of the automatic repository setup tools in which case the previous repo identifier should already be your repo's details.
...
- First rebase to the unsigned image, to get the proper signing keys and policies installed:
  ```
  sudo rpm-ostree rebase ostree-unverified-registry:ghcr.io/Gaming4LifeDE/cosmos-os:latest
  ```
...
- Then rebase to the signed image, like so:
  ```
  sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/Gaming4LifeDE/cosmos-os:latest
  ```
...
```
sudo rpm-ostree rebase ostree-image-signed:docker://ghcr.io/Gaming4LifeDE/cosmos-os:20230403
```
